  ...
  return (
    <main className="min-h-screen bg-ivory px-6 py-10 text-navy">
      ...
      <div className="mx-auto max-w-4xl">
        <Link href={`/sessions/${session.id}`} className="text-sm font-semibold text-graphite">Back to session</Link>
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_.85fr]">
          <section className="rounded-[34px] border border-sky/20 bg-white p-8 shadow-stripe">
            <p className="text-sm font-semibold uppercase tracking-[.24em] text-coral">Pledge confirmation</p>
            ...
            <div className="mt-8 rounded-[28px] bg-ivory p-6 text-navy">
              ...
              <p className="mt-2 text-graphite">{customAmountCents ? `Your ${formatCurrency(pledgeAmountCents)} pledge qualifies for this level.` : tier.description}</p>
              ...
              {customAmountCents ? (
                <div className="mt-6 rounded-2xl border border-gold/40 bg-gold/15 p-4 text-sm font-medium text-navy">
          ...
          <aside className="rounded-[34px] border border-sky/20 bg-white p-8 shadow-stripe">
